...
1月20日(木) 15時~から、zoom によるオンライン講義を行ないます。
...
*** 毎回のアンケート
     ...
     [[https://forms.gle/hCMpTPbHt3q2fCRF7][12回目のアンケート]]
...
***** 二元配置 [/]
      - [ ] [[https://www.stats-guild.com/analytics/15657][2元配置分散分析（Two-way ANOVA）]]概説，stats-guild
      - [ ] [[https://multivariate-statistics.com/2021/10/24/statistics-two-way-anova/][【統計学】分散分析 一元配置分散分析・二元配置分散分析]]   - 完璧
      - [ ] 演習 [[http://whitewell.sakura.ne.jp/R/][Webpage for Probability Theory and Statistics (B)]]
...
**** 次週の演習
      ...
      - 次週，各自このページを読み理解し演習し，pdf/HTMLページにまとめ
        ましょう。
