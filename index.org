...
**** Rの演習
     - http://wiki.cis.iwate-u.ac.jp/~suzuki/bio_stat/org/R-text-3.html
       - 2. データの図示と基本統計量の計算 をやってみましょう
...
** R 入門
   ...
   先生の演習ノート 
     - [[./org/R-intro-1.org]] - 基本操作
     - [[./org/R-intro-2.org]] - データ処理
     - [[./org/R-intro-3.org]] - 89ファイルの読み書き, 10スクリプトの実行, 11関数を作る
     - [[./org/R-intro-4.org]] - 12グラフ
     - [[./org/R-intro-5.org]] - 13構文
